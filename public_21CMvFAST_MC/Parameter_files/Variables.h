...
//JBM:whether to print out the power spectrum of initial velocities (just for debugging purposes)
#define PRINT_DEBUG_REL_VEL (int) 0
...
float **vcb_rev;
double **logFcoll_vcb; //the Fcoll(z,v) table for interpolation
double **sigmacool_vcb; //the sigma(M_cool | v,z)
...
//JBM: also average Tgas (Tkin) and Tspin
double *aveTkin, *aveTspin, *aveXalpha;
